...
import { getInProgressProductList, getProductList, setproductList } from '../../../stores/productSlice';
...
const NowList = ( { selectProd, particpateProd, openAuction  } : Props) => {
            ...
            <View style={styles.listContainer}>
            {
              product.productList.length > 0 ? (
                ...
                <View style={styles.noDataContainer}>
                  <Text style={styles.noDataText}>Aucune enchère en cours pour le moment. De nouvelles enchères seront ajoutées bientôt !"</Text>
                </View>
              )
            }
          </View>
    ...
    const getProducts = async() => {
        setIsLoaded(false)
        const res = await getInProgressProductList(profile.connexionInfo.idClient);
