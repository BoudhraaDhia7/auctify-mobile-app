...
type FavScreenProp = NativeStackNavigationProp<RootStackParamList, 'Favourite'>;

const Favourite = () => {

    const navigation = useNavigation<FavScreenProp>();
    ...
    return(
        <View style={globalStyles.container}>
            ...
            <BackSection label="Participations" logo={true} navigateTo={navigateTo} from='Main'/>
